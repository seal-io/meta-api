...
var KnownParts = map[string]string{
	PartApplication:     "application",
	PartOperatingSystem: "operating system",
	PartHardware:        "hardware",
}
...
// ShouldWFNize likes WFNize but without error returning.
func ShouldWFNize(s string) string {
	s, _ = WFNize(s)
	return s
}
