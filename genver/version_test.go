...
func TestParse(t *testing.T) {
	var cases = []struct {
		...
		},
		{
			...
			expected: ParsedVersion{
				Original: "0.2.0-prerelease.20200714185213",
				Epoch:    "0",
				Major:    "0",
				Minor:    "2",
				Patch:    "0",
